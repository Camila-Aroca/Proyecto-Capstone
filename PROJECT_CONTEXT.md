...
El producto apoya planificación mediante evidencia reproducible; no es un sistema de gestión de cupos en tiempo real ni un dashboard meramente descriptivo.
...
- 2026 es una fuente mutable y debe tratarse como snapshot.

### Accesibilidad
- Establecimientos DEIS.
- Cartografía Censo 2024.
- Red vial OSM y transporte público GTFS.
- Objetivo: isócronas, cobertura poblacional, vulnerabilidad y brechas comunales.

### Hospitalización
- Fuente: Egresos Hospitalarios DEIS 2020–2025.
- `DIAG1`: diagnóstico principal CIE-10.
- `DIAG2`: causa externa CIE-10.
- Objetivo: analizar duración de estadía F00–F99 y diferencias asociadas a edad, previsión, pertenencia al sistema y condición de egreso.
...
- Cualquier relación Urgencias–Egresos será ecológico-territorial.
...
- `data/raw/` es inmutable durante procesamiento.
