...
22. `build_mart_mvp_territorial_comuna` → (Mart canónico MVP territorial comunal: integra demanda 2025, población 2025/2024, vulnerabilidad 2022 y oferta actual en una fila por comuna RM)
23. `eda_contexto_genero` → (EDA reproducible de los cuatro cuadros contextuales)
